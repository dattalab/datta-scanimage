...
% handles    structure with handles and user data (see GUIDATA)
	hideGUI('gh.chooser.figure1');
    global state
	initTimer(state.analysisMode, {'Imaging', 'LineMonitor'}); %, 'Olfactometer'});
...
% handles    structure with handles and user data (see GUIDATA)
	hideGUI('gh.chooser.figure1');
    global state
	initTimer(state.analysisMode, {'Physiology', 'LineMonitor'}); %, 'Olfactometer'});	
...
% handles    structure with handles and user data (see GUIDATA)
	hideGUI('gh.chooser.figure1');
    global state
	initTimer(state.analysisMode, {'Imaging', 'Physiology', 'LineMonitor'}); %, 'Olfactometer'});
