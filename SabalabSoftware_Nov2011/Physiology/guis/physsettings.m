...
% Last Modified by GUIDE v2.5 26-Jan-2011 00:58:16
...
function streamToDisk_CreateFcn(hObject, eventdata, handles)
% hObject    handle to streamToDisk (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
...
function amSys1800Chan0HWGain_Callback(hObject, eventdata, handles)
	genericCallback(hObject);
	setAMSys1800HWGain

function amSys1800Chan1HWGain_Callback(hObject, eventdata, handles)
    genericCallback(hObject);
	setAMSys1800HWGain


% --- Executes during object creation, after setting all properties.
function amSys1800Chan0HWGain_CreateFcn(hObject, eventdata, handles)
% hObject    handle to amSys1800Chan0HWGain (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes during object creation, after setting all properties.
function amSys1800Chan1HWGain_CreateFcn(hObject, eventdata, handles)
% hObject    handle to amSys1800Chan1HWGain (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
