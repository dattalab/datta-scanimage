...
%% ---------------------------------------------------------------------------
    function build_gui()
        ...
        uimenu(handles.menuFile,'Label','Load configuration','Callback','');
        uimenu(handles.menuFile,'Label','Save configuration','Callback','');
        uimenu(handles.menuFile,'Label','Save configuration as...','Callback','');
        ...
        handles.triggerDALabel = uicontrol( ...
            'Parent', handles.figure1, ...
            'Tag', 'triggerDA', ...
            'Style', 'text', ...
            'Units', 'characters', ...
            'Position', [24 43.0769230769231 12.4 1.07692307692308], ...
            'String', 'Trigger DA');
        
        handles.valveStatusDALabel = uicontrol( ...
            'Parent', handles.figure1, ...
            'Tag', 'valveStatusDA', ...
            'Style', 'text', ...
            'Units', 'characters', ...
            'Position', [19 44.8461538461538 16.8 1.07692307692308], ...
            'String', 'Valve Status DA');
        
        %% loop for the frame specifications
        labels={'Init', 'Pre' , 'Odor', 'Post'};
        ...
        handles.olfactometerEnable = uicontrol( ...
            ...
            'String', 'enable?', ...
            'Callback', @(hObject,eventdata)olfactometer('enable_Callback',hObject,eventdata,guidata(hObject)));
        ...
        handles.popupmenu1 = uicontrol( ...
            'Parent', handles.figure1, ...
            'Tag', 'valveStatusDAValue', ...
            'Style', 'popupmenu', ...
            'Units', 'characters', ...
            'Position', [36.4 44.6923076923077 19 1.53846153846154], ...
            'BackgroundColor', [1 1 1], ...
            'String', {'Aux 4','Aux 5','Aux 6','Aux 7'}, ...
            'Value', 1, ...
            'Callback', @(hObject,eventdata)olfactometer('enable_Callback',hObject,eventdata,guidata(hObject)));
        ...
        handles.popupmenu2 = uicontrol( ...
            ...
            'Style', 'popupmenu', ...
            'Units', 'characters', ...
            'Position', [36.4 42.8461538461538 19 1.53846153846154], ...
            'BackgroundColor', [1 1 1], ...
            'String', {'Aux 4','Aux 5','Aux 6','Aux 7'}, ...
            'Value', 2, ...
            'Callback', @(hObject,eventdata)olfactometer('enable_Callback',hObject,eventdata,guidata(hObject)));
        ...
        for i = 1:16
            ...
            handles.valveEnable(i) = uicontrol( ...
                ...
                'Callback', @(hObject,eventdata)olfactometer('generic_Callback',hObject,eventdata,guidata(hObject)));
   if (i==1)
                set(handles.valveEnable(i), 'Enable', 'off');
                set(handles.valveEnable(i), 'Value', [0]);
