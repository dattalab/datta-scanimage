function spSetPath(exptNumber, exptLetter)

    global state
   
    basedir='C:\Users\user\Desktop\DATA\stan\';
	disp(basedir);
    ...
    if (nargin == 0)
        ...
        dirname = [basedir 'sp' num2str(exptNumber) exptLetter];
        state.files.baseName = ['sp' num2str(exptNumber) exptLetter '_e1_'];
    end
