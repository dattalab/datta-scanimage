function motorSetPosition(coordType,newPos,displayMode,forceSecZ)
%% function motorSetPosition(coordType,newPos,displayMode,forceSecZ)
...
switch coordType
    case 'absolute'  
        ...
        if state.motor.motorZEnable || forceSecZ
...
if ~state.motor.motorZEnable && ~forceSecZ
    moveCompleteFcn(newPos(1:3)); %Evaluates appropriate moveCompleteXXX() method
else
