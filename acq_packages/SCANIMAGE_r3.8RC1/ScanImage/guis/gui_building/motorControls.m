...
% Last Modified by GUIDE v2.5 27-Oct-2011 21:11:01
...
function etZPosAlt_Callback(hObject, eventdata, handles)
% hObject    handle to etZPosAlt (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of etZPosAlt as text
%        str2double(get(hObject,'String')) returns contents of etZPosAlt as a double
genericCallback(hObject);
motorSetPositionRelative([],'verify',true);
...
state.hSICtl.motorStep_Callback(axis,'dec');
...
state.hSICtl.motorStep_Callback(axis,'inc');
