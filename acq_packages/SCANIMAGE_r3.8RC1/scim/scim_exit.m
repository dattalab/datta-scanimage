...
if ~isempty(state.internal.roifigure) && ishandle(state.internal.roifigure)
    delete(state.internal.roifigure);
end
if ~isempty(state.internal.roifigureNew) && ishandle(state.internal.roifigureNew) % TODO: remove this
    delete(state.internal.roifigureNew);
end
