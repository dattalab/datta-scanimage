// GetMostRecentImage.cpp : Defines the exported functions for the DLL application.
//

#include "stdafx.h"

//Matlab signature
//outputData = GetMostRecentImage(cameraObj,outputClassNumBits,outputVarOrSize)
...
char methodName[MAXVARNAMESIZE] = "getMostRecentImage";
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
	...
	{
		case 16:
			status = GetMostRecentImage16((WORD *)outputDataPtr,outputVarSize);
		break;

		case 32:
			status = GetMostRecentImage((at_32 *)outputDataPtr,outputVarSize);
		break;
	}
