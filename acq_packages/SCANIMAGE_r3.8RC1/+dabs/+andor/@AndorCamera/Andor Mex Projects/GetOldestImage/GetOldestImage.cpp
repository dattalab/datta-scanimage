// GetOldestImage.cpp : Defines the exported functions for the DLL application.
//

#include "stdafx.h"

//Matlab signature
//outputData = GetOldestImage(cameraObj,outputClassNumBits,outputVarOrSize)
...
char methodName[MAXVARNAMESIZE] = "getOldestImage";
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
	...
	{
		case 16:
			status = GetOldestImage16((WORD *)outputDataPtr,outputVarSize);
		break;

		case 32:
			status = GetOldestImage((at_32 *)outputDataPtr,outputVarSize);
		break;
	}
