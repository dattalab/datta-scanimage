% getPointsFromAxes - Get mouse-selected points from an axes.
%
% SYNTAX
%  [x, y] = getPointsFromAxes
%  [x, y] = getPointsFromAxes(ax)
%  [x, y] = getPointsFromAxes(ax, propertyName, propertyValue)
%  [x, y] = getPointsFromAxes(f)
%  [x, y] = getPointsFromAxes(f, propertyName, propertyValue)
...
function [x, y] = getPointsFromAxes(varargin)
