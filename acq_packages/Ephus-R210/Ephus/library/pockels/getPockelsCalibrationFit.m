...
function [coeffs, maxV, minV, offset] = getPockelsCalibrationFit(pockelsCellDevice, photodiodeDevice, triggerOrigin, pockelsCellTriggerDestination, photodiodeTriggerDestination, shutterDevice, minModulationVoltage, maxModulationVoltage, varargin)
