% ephys_getData - Retrieve data that needs to be saved.
%
% SYNTAX
%  ephys_getData(hObject)
%
% USAGE
%
% NOTES
...
%
% SEE ALSO
%  ephys_saveTrace (TO123005E)
%
% Created 12/30/05 Tim O'Connor
% Copyright - Cold Spring Harbor Laboratories/Howard Hughes Medical Institute 2005
function data = ephys_getData(hObject)
% fprintf(1, '%s - ephys_getData\n', datestr(now));
data = [];
...
%         end
        ...
        %TO062306A %TO062806A
        if acqOnArray(i)
            msg = sprintf('Warning: Ignoring call to save ephys trace_%s because buffer %s is empty.\n', num2str(i), num2str(i));
