% ephys_pulseCreation - Callback for updating the selected pulses when changed externally.
%
% SYNTAX
...
function ephys_pulseCreation(hObject)

[currentDir pulseName pulseSetName ampIndex pulseNameArray stimOnArray] = ...
    getLocalBatch(progmanager, hObject, 'pulseSetDir', 'pulseName', 'pulseSetName', 'amplifierList', 'pulseNameArray', 'stimOnArray');
