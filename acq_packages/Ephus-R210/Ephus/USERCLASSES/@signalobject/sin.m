% sin(SIGNAL, amplitude, offset, frequency, phi) - Parameterizes this SIGNAL object as a sine wave.
%
% SYNTAX
...
function sin(this, amplitude, offset, frequency, phi)
...
set(this, 'Type', 'Analytic', 'Periodic', 1, 'Waveform', 'sine');
