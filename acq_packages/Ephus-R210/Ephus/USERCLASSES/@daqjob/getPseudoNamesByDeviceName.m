% @daqjob/getPseudoNamesByDeviceName - Convert an physical channel name into pseudochannels.
%
% SYNTAX
%  mnemonicChannelNames = getPseudoNamesByDeviceName(this, physicalName)
%   this - The @daqjob instance.
%   physicalName - The real channel name(s).
...
function mnemonicChannelNames = getPseudoNamesByDeviceName(this, physicalName)

mnemonicChannelNames = channelNamesToPseudoChannels(this, getChannelNameByDeviceName(this, physicalName));
