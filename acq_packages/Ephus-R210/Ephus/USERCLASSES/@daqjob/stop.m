...
%  TO102508C - Prune pseudochannels from the channelsToStart list. -- Tim O'Connor 10/25/08
%
% Created
...
pseudoChannelsToStop = channelNamesToPseudoChannels(this, channelsToStop);
...
daqjobGlobalStructure(this.ptr).channelsToStart = setdiff(daqjobGlobalStructure(this.ptr).channelsToStart, pseudoChannelsToStop);%TO102508C
...
for i = 1 : length(taskList)
    ...
    channelsToRestart = setdiff(channels, getDeviceNameByChannelName(this, pseudoChannelsToStop));%TO102508C - Prune pseudochannels too.
...
daqjobGlobalStructure(this.ptr).startedChannels = setdiff(daqjobGlobalStructure(this.ptr).startedChannels, pseudoChannelsToStop);%TO102508C
