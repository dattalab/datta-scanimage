% @daqjob/addAnalogInput - Add analog input channel.
%
% SYNTAX
%  addAnalogInput(job, channelName, subsystemName, channelID)
...
function addAnalogInput(this, channelName, subsystemName, channelID)
...
daqjobGlobalStructure(this.ptr).channelMap{index, 4} = 'analogIn';
nimex_addAnalogInput(task, [subsystemName channelID]);
