% @nimex/nimex_registerSamplesAcquiredPreprocessor - Adds a listener for the specified channels data.
% 
% SYNTAX
%  nimex_registerSamplesAcquiredPreprocessor(nimextask, channelName, callback, name, priority)
...
function nimex_registerSamplesAcquiredPreprocessor(this, channelName, callback, name, priority)
...
NIMEX_registerSamplesAcquiredPreprocessor(this.NIMEX_TaskDefinition, channelName, callback, name, priority);

% fprintf(1, 'nimex_registerSamplesAcquiredPreprocessor: this.NIMEX_TaskDefinition = %s\n', num2str(this.NIMEX_TaskDefinition));
