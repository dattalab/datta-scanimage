% @nimex/nimex_bindEveryNCallback - Adds a callback listener for the specified event.
% 
% SYNTAX
%  nimex_bindEveryNCallback(nimextask, callback, name, priority)
...
%  
% NOTES
%  Relies on NIMEX_bindEventListener.mexw32 (formerly NIMEX_bindEveryNCallback.mex32).
%
% CHANGES
...
function nimex_bindEveryNCallback(this, callback, name, priority)
...
% NIMEX_bindEveryNCallback(this.NIMEX_TaskDefinition, callback, name, priority);
NIMEX_bindEventListener(this.NIMEX_TaskDefinition, 'everyN', callback, name, priority);

% fprintf(1, 'nimex_bindEveryNCallback: this.NIMEX_TaskDefinition = %s\n', num2str(this.NIMEX_TaskDefinition));
