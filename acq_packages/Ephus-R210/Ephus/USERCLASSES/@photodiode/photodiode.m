% photodiode/photodiode - A photodiode representation (including hardware configuration and power calibration).
%
% SYNTAX
%  photodiode
%  photodiode(name)
...
%  lensTransmission - The percentage of total light transmitted by the lens.
%
% NOTES
%
% CHANGES
...
if isempty(varargin)
    ...
    photodiodeObjects(this.ptr).lensTransmission = 100;%TO030706C
else
