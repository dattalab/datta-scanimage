% @pulseMap/pulseMap - A table-based object relating channel names to pulses.
%
% SYNTAX
%  pulseMap(name) - Create a new @pulseMap, or retrieve an existing @pulseMap object, with the specified name.
%   name - The name of the @pulseMap object to be created/recieved.
%
% NOTES
%
% CHANGES
