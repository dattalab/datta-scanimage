...
%      Style is not a supported attribute of a 'figure' object. - TO060810B Tim O'Connor 6/8/10
...
%Style is not a supported attribute of a 'figure' object. - TO060810B Tim O'Connor 6/8/10
style = '';
if ~any(strcmpi(get(progmanagerglobal.programs.(program_name).(gui_name).guihandles.(handle_tag), 'Type'), {'axes', 'figure'}))
...
cachedStatement = lower(varargin(cellfun('isclass',varargin,'char') == 1));
