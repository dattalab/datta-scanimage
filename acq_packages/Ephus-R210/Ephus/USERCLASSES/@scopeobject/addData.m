...
%  TO042309A: Calling drawnow causes the Done event to get processed before we have finished processing the EveryN event. The new 'expose' feature is working now. -- Tim O'Connor 4/23/09
