...
%  TO032510A: Small cleanup (removed an unnecessary assignment of yData and swiched an `strcmpi(class(...), ...)` to `iscell`). -- Tim O'Connor 3/25/10
%
...
if isempty(varargin)
    ...
    set(scopeObjects(this.ptr).bindings{index, 2}, 'YData', [], 'XData', []);
end
