...
fireEvent(loopManagers(this.ptr).callbackManager, 'objectUpdate');%TO100705E
fireEvent(getUserFcnCBM, 'loopManager:start');%TO122009A
...
fireEvent(loopManagers(this.ptr).callbackManager, 'objectUpdate');%TO100705E
fireEvent(getUserFcnCBM, 'loopManager:start');%TO121909A
...
% fprintf(1, '%s - @loopmanager/start/timerFcn: Firing ''loopManager:iterate'' event...\n', datestr(now));
fireEvent(getUserFcnCBM, 'loopManager:iterate');%TO121909A
% fprintf(1, '%s - @loopmanager/start/timerFcn: Finished ''loopManager:iterate'' event.\n', datestr(now));
...
fireEvent(getUserFcnCBM, 'loopManager:stop');%TO121909A
