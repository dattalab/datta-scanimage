% imagingSystem/imagingSystem - An imagingSystem representation (including hardware configuration and alignment/calibration).
%
% SYNTAX
%  imagingSystem
%  imagingSystem(name)
...
%  xBoardID - The board ID of the X-axis this imagingSystem.
%  xChannelID - The channel ID of the X-axis this imagingSystem.
%  xOffset - The "nominal" offset of the X-axis (defined 0).
%  xGain - The 
%  yBoardID - The board ID of the Y-axis this imagingSystem.
%  yChannelID - The channel ID of the Y-axis this imagingSystem.
%  yOffset - The "nominal" offset of the Y-axis (defined 0).
%
