% @AXOPATCH_200B/getHeaderInfo - Creates a structure of information that should get stored into headers of any program using this object.
%
% SYNTAX
...
headerInfo.v_hold = get(this, 'v_hold');
headerInfo.beta = get(this, 'beta');
